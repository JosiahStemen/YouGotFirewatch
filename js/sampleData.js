...
export function createSampleAdncoStudents() {
  return [
    { id: generateId(), rank: 'LCpl', lastName: 'Garcia', firstName: 'Luis', phoneNumber: '831-555-0101', studentType: 'MAT', adncoPoints: 4, lastAdncoDutyDate: null, adncoNonAvailabilityInput: '' },
    { id: generateId(), rank: 'Cpl', lastName: 'Anderson', firstName: 'Sarah', phoneNumber: '831-555-0102', studentType: 'Academic', adncoPoints: 6, lastAdncoDutyDate: null, adncoNonAvailabilityInput: '10-12' },
    { id: generateId(), rank: 'PFC', lastName: 'Miller', firstName: 'James', phoneNumber: '831-555-0103', studentType: 'MAT', adncoPoints: 3, lastAdncoDutyDate: null, adncoNonAvailabilityInput: '' },
    { id: generateId(), rank: 'PFC', lastName: 'Chen', firstName: 'Amy', phoneNumber: '831-555-0104', studentType: 'Academic', adncoPoints: 5, lastAdncoDutyDate: null, adncoNonAvailabilityInput: '5, 15-17' },
    { id: generateId(), rank: 'LCpl', lastName: 'Rivera', firstName: 'Marcus', phoneNumber: '831-555-0105', studentType: 'MAT', adncoPoints: 7, lastAdncoDutyDate: null, adncoNonAvailabilityInput: '' },
  ];
}